...
# Constants
# -----------------------------
DAILY_TARGET = 20  # Change your daily job target here
...
# Helper Functions
# -----------------------------
def append_job_log(date_, platform, count):
    job_sheet.append_row([str(date_), platform, str(count)])

def append_tech_log(date_, tech, progress, source):
    tech_sheet.append_row([str(date_), tech, progress, source])
